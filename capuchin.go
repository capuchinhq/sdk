// Package capuchin is the Capuchin agent SDK: define tools and agents in plain Go and run
...
//
// Run `capuchin dev` in the project directory to bring up the local stack (embedded
// Temporal + web UI) and build/run this worker with hot reload; `capuchin chat` talks
// to the agent.
package capuchin
